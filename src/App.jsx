...
body{font-family:var(--fb);background:var(--bg);color:var(--txt);font-size:15px;line-height:1.6;-webkit-font-smoothing:antialiased;overflow-x:hidden;}
#root{background:#0f172a;min-height:100vh;width:100%;}
...
//  Inject CSS immediately (module-level, no flash) 
(()=>{ try{ const s=document.createElement("style"); s.id="ecomm-styles"; if(!document.getElementById("ecomm-styles")){ s.textContent=CSS; document.head.appendChild(s); } }catch(e){} })();
...
export default function App() {
  ...
  // CSS injected immediately at module level (not useEffect) so no flash of white
  useEffect(()=>{},[]);// keep hook count stable
